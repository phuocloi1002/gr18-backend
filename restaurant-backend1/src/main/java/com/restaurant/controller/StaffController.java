...
public class StaffController {
    ...
    public ResponseEntity<ApiResponse<List<CallStaff>>> getPendingCalls() {
        return ResponseEntity.ok(ApiResponse.success(staffOperationsService.getPendingCallStaffRequests()));
    }
    ...
    public ResponseEntity<ApiResponse<CallStaff>> resolveCall(@PathVariable Long id) {
        CallStaff call = staffOperationsService.resolveCallStaffRequest(id);
